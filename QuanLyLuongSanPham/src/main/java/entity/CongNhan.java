...
public class CongNhan {
    ...
    public CongNhan(String maCongNhan, String tenCongNhan, Date ngaySinh, boolean gioiTinh, String diaChi, String soDienThoai, String email, String cmnd, Date ngayBatDau, Double troCap, String tayNghe) {
        this.maCongNhan = maCongNhan;
        this.tenCongNhan = tenCongNhan;
        this.ngaySinh = ngaySinh;
        this.gioiTinh = gioiTinh;
