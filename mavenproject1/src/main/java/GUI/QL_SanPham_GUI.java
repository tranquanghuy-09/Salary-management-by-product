 ...
 * @author duy19
 */
public class QL_SanPham_GUI extends javax.swing.JFrame {

    /**
     * Creates new form QL_SanPham_GUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QL_SanPham_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QL_SanPham_GUI().setVisible(true);
            }
        });
    }
