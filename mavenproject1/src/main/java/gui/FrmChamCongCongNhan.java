 ...
 */
public class FrmChamCongCongNhan extends javax.swing.JPanel {

    private final ChamCongCNDao chamCongCNDao;

    public FrmChamCongCongNhan() throws Exception {
    ...
    private void loadTableData() {
        PhanCongCNDao phanCongDao = new PhanCongCNDao();
        ...
        for (PhanCong phanCong : phanCongs) {
            model.addRow(new Object[]{
                phanCong.getMaPC(),
                phanCong.getCongDoan().getMaPhanDoan(),
    ...
    private void loadTableData2() throws Exception {
        ...
        for (ChamCongCN chamCong : chamCongList) {
            model.addRow(new Object[]{
                ...
                chamCong.getPhanCong().getMaPC(),
                chamCong.getPhanCong().getCongDoan().getMaPhanDoan(),
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách công nhân được phân công", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void btnChamCongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChamCongActionPerformed
        ...
        if (result) {
            ...
            try {
                ...
                Logger.getLogger(FrmChamCongCongNhan.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    private void btnXoaChamCongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaChamCongActionPerformed
        ...
        if (row != -1) {
            ...
            String maPhanCong = tblDanhSachChamCong.getValueAt(row, 2).toString();

            if (chamCongCNDao.xoaChamCong(maChamCong, maPhanCong)) {
                ...
                JOptionPane.showMessageDialog(this, "Xóa chấm công không thành công");
            }
        } else {
    ...
    private void btnXuatExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatExcelActionPerformed
        // TODO add your handling code here:
        XuatFileExcel.xuatFileExcel(tblDanhSachChamCong);
