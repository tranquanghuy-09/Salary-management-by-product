...
import dao.BangLuongCNDao1;

import dao.ChamCongCNDao1;
...
import entity.CongNhanDaChamCong1;
 ...
 * @author duy19
 */
public class FrmTinhLuongCN extends javax.swing.JPanel {

    private DefaultTableModel model, model1;
    private CongNhanDao1 cn_dao = new CongNhanDao1();
    private ChamCongCNDao1 chamCongCN_dao = new ChamCongCNDao1();
    private BangLuongCNDao1 bangLuongCN_dao = new BangLuongCNDao1();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tính Lương Công Nhân");
                            ...
                            .addGroup(ThongTinPCLayout.createSequentialGroup()
                                .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ThongTinPCLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(txtThangLuong, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(ThongTinPCLayout.createSequentialGroup()
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ThongTinPCLayout.createSequentialGroup()
                                        .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(lblMaSanPham12, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtTroCap, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(txtSLDaLam, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                .addGap(29, 29, 29))
                            .addGroup(ThongTinPCLayout.createSequentialGroup()
                                .addComponent(lblMaSanPham11, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(txtMaPhieuLuong, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, ThongTinPCLayout.createSequentialGroup()
                                    ...
                                    .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(txtNamLuong, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
                                ...
                                .addComponent(txtHeSoCa, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(38, 38, 38))
                    .addGroup(ThongTinPCLayout.createSequentialGroup()
                        .addComponent(lblMaSanPham13, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtGiaPhanDoan, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
            ...
            .addGroup(ThongTinPCLayout.createSequentialGroup()
                ...
                .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ThongTinPCLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(ThongTinPCLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(ThongTinPCLayout.createSequentialGroup()
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách phân công", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        ...
        btnTinhLuong.setBackground(new java.awt.Color(102, 255, 153));
        btnTinhLuong.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnTinhLuong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Images/icon-LamMoi.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ThongTinPC, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public void loadDataToTable() {
        try {
            List<ChamCongCN1> list = chamCongCN_dao.getAllChamCong();
            model.setRowCount(0);
            for (ChamCongCN1 chamCong : list) {
                {
    ...
    public void loadDataToTableTinhLuong() {
        try {
            List<BangLuongCN1> list = bangLuongCN_dao.getDSLuongCN();
            model1.setRowCount(0);
            for (BangLuongCN1 bang : list) {
                {
    ...
    private void tblDSCongNhanDaChamCongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSCongNhanDaChamCongMouseClicked
        ...
        try {
            ...
            if (row >= 0) {
                ...
                ChamCongCN1 chamCongCN = chamCong_dao.getChamCongByID(maChamCong);
                if (cn != null) {
    ...
    private void btnTinhLuongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTinhLuongActionPerformed
        ...
        double tongLuong = soLuongDaLam * giaPhanDoan * heSo + troCap;
            CongNhan1 cn = cn_dao.getCNByID(txtMaCN.getText());
            Calendar calendar = Calendar.getInstance();
            ChamCongCN1 chamCongCN;
            chamCongCN = chamCongCN_dao.timChamCongTheoMaCN(cn.getMaCongNhan());   
            BangLuongCN1 bangLuong;
            bangLuong = new BangLuongCN1(txtMaPhieuLuong.getText(), Integer.parseInt(txtNamLuong.getText()), Integer.parseInt(txtThangLuong.getText()), chamCongCN, tongLuong);
             bangLuongCN_dao.themLuongCN(bangLuong);
          }catch (Exception ex) {
            Logger.getLogger(FrmTinhLuongCN.class.getName()).log(Level.SEVERE, null, ex);
        }
            loadDataToTableTinhLuong();
